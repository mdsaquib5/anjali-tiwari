            ...
            <div className="container">
                <div className="about-main">
                    <div className="about-img">
                        <Image src="/story-7.webp" alt="main-story" width={640} height={860} priority />
                    </div>
                    <div className="about-content">
                        ...
                        <div className="story-slider">
                            <div className="story-img">
                                <Image src="/story-1.webp" alt="story" width={640} height={860} priority />
                            </div>
                            <div className="story-img">
                                <Image src="/story-2.webp" alt="story" width={640} height={860} priority />
                            </div>
                            <div className="story-img">
                                <Image src="/story-3.webp" alt="story" width={640} height={860} priority />
                            </div>
                            <div className="story-img">
                                <Image src="/story-4.webp" alt="story" width={640} height={860} priority />
                            </div>
                            <div className="story-img">
                                <Image src="/story-5.webp" alt="story" width={640} height={860} priority />
                            </div>
                            <div className="story-img">
                                <Image src="/story-6.webp" alt="story" width={640} height={860} priority />
                            </div>
                        </div>
                    </div>
                </div>
